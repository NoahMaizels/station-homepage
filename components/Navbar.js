...
export default function Navbar() {
  ...
  return (
    ...
    <Popover>
      {({ open }) => (
        <>
          <div id="main-nav" className="transition-top duration-500 fixed top-0 left-0 w-full z-10">
              ...
              <div className="hidden lg:flex space-x-4 items-center justify-end ">
                ...
                <a
                  ...
                  <svg
                    ...
                    <path
                      className="transition-colors"
                      fill={hoverState.telegramann === true ? '#e5e7eb' : '#00f892'}
                      d="M43.17 21.585c0 11.921-9.664 21.586-21.585 21.586C9.664 43.17 0 33.506 0 21.585 0 9.665 9.664 0 21.585 0 33.506 0 43.17 9.664 43.17 21.585"
                    />
                    <path
                      fill="#464383"
                      d="M32.218 9.877H12.09a2.523 2.523 0 00-2.516 2.516v22.644l5.032-5.032h17.612a2.523 2.523 0 002.516-2.516V12.393a2.524 2.524 0 00-2.516-2.516"
                    />
                    <path
                      fill={hoverState.telegramann === true ? '#e5e7eb' : '#00f892'}
