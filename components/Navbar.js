...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 main-nav w-full ${show && '-top-72'}`} >
          ...
          <div className="flex justify-between items-center border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <Link href="/ ">
              ...
              <a target="_blank" href="mailto:fomocraft@gmail.com" className=" flex items-center rounded-md">                  
                <span className=" text-base font-semibold text-primary">Contact</span>
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a
                href="#"
                className="whitespace-nowrap text-base font-semibold text-gray-500 hover:text-gray-900">
            
              </a>
              <a
                href="#"
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-semibold ">
            ...
            <div className="pt-5 pb-6 px-5">
              ...
              <a>
                  ...
                  <svg className="h-6 w-6 ml-2" fill="black" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <span className="ml-2 text-base font-semibold text-gray-900">Follow us</span>
