const Medium = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
...
const Telegram = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
      onMouseOver={handleMouseOver}
...
const Telegramann = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
      onMouseOver={handleMouseOver}
...
const Twitter = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
      onMouseOver={handleMouseOver}
...
const TelegramDark = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
      onMouseOver={handleMouseOver}
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 43.171 43.171">
        ...
        <path
          className="transition-colors"
          fill={hoverState.telegramDark === true ? '#e5e7eb' : '#333266'}
          d="M43.17 21.585c0 11.921-9.664 21.586-21.585 21.586C9.665 43.17 0 33.506 0 21.585 0 9.665 9.664 0 21.585 0c11.921 0 21.586 9.664 21.586 21.585"
        />
        <path
          fill="#00f892"
...
const TelegramannDark = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
      onMouseOver={handleMouseOver}
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 43.17 43.171">
        ...
        <path
          className="transition-colors"
          fill={hoverState.telegramannDark === true ? '#e5e7eb' : '#333266'}
          d="M43.17 21.585c0 11.921-9.664 21.586-21.585 21.586C9.664 43.17 0 33.506 0 21.585 0 9.665 9.664 0 21.585 0 33.506 0 43.17 9.664 43.17 21.585"
        />
        <path
          fill="#00f892"
...
const TwitterDark = ({ hoverState, handleMouseOver, handleMouseLeave }) => {
  return (
    <a
      className="navIcon"
      onMouseOver={handleMouseOver}
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 43.171 43.171">
        ...
        <path
          className="transition-colors"
          fill={hoverState.twitterDark === true ? '#e5e7eb' : '#333266'}
          d="M43.17 21.585c0 11.921-9.663 21.586-21.585 21.586C9.665 43.17 0 33.506 0 21.585 0 9.665 9.664 0 21.585 0c11.922 0 21.586 9.664 21.586 21.585"
        />
        <path
          fill="#00f892"
