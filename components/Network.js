  ...
  return (
    <div
      ...
      <div className="relative">
        <div className="mx-auto lg:max-w-4xl max-w-xl lg:px-8 lg:grid lg:grid-cols-3 lg:grid-flow-col-dense mb-16 sm:mb-24 lg:mb-32">
          <div className="px-4">
            <h2 className="text-4xl font-extrabold font-gilroy text-secondary tracking-tight text-gray-900">
              A Network of SubStations
            </h2>
            <p className="mt-4 text-sm font-open-sans text-gray-700">
